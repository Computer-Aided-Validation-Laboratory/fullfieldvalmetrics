...
def main() -> None:
    ...
    EXP_DIR = Path.cwd() / "synthetic_data/case11_1/pyvale-output"
    SIM_DIR = Path.cwd() / "synthetic_data/case11_1/pyvale-output"
    num_tc = 36
    ...
    save_path = Path.cwd() / "synthetic_data/case11_1/pyvale-output/valid"
