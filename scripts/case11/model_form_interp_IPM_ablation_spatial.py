...
from ablation_funcs import mape_func, interval_score, regression_accuracy_metrics, load_data_with_file
...
# EXP_DIR = Path.cwd() / "ipm_interp_spatial"
EXP_DIR = (
    Path.cwd()
    / "synthetic_data"
    / "case11"
...
def main():
    ...
    merged_df, d_types = load_data_with_file(INPUT_FILE, COORDS_FILE)
